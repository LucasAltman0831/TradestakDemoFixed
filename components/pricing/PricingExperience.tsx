...
const plans:Record<Role,Plan[]>={
  ...
  suppliers:[
    ...
    {name:'Supplier Growth',monthly:79,yearly:65,purpose:'Inquiry intelligence for suppliers handling meaningful buyer demand.',future:true,features:['Everything planned for Supplier Pro','Multiple locations','Inquiry analytics and team response visibility','Response-time and contact analytics','CRM integrations as the product matures']},
