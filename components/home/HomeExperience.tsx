...
const businessFeatures=[
  ...
  {icon:Target,title:'Connect and meet',text:'Save suppliers, send private inquiries, and request introductory meetings.',href:'/signup?role=business',action:'Create a business workspace'},
];
...
export function HomeExperience({viewer}:{viewer:{name:string|null;role:string;dashboard:string}|null}){return <div className={styles.page}>
  ...
  <main>
    ...
    <section className={styles.signalStrip} id="how-it-works" aria-label="How SourceMetric works"><span>DISCOVER</span><i/><span>EVALUATE</span><i/><span>COMPARE</span><i/><span>CONNECT</span><i/><span>MEET</span></section>
