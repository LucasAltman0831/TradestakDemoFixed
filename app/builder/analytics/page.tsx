...
export default async function Page(){
  ...
  const {data:saved}=await supabase.from('saved_suppliers').select('supplier_profiles(*)').eq('builder_user_id',user.id);
  ...
  return <main className="shell"><Sidebar role="builder"/><section className="workspace">
