...
export default async function Page({params}:{params:Promise<{supplier:string}>}){
  ...
  return <ClaimWorkflow supplier={{...company,description:null,score:0,quality_score:0,delivery_score:0,communication_score:0,review_count:0,verified:false,source_name:'TradeStak network',years:0}}/>;
}
