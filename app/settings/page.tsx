...
export default async function Page(){
  const {profile}=await requireRole(['builder','supplier','admin']);
  const roleLabel=profile.role==='builder'?'Business / Buyer':profile.role==='supplier'?'Supplier':'Administrator';
