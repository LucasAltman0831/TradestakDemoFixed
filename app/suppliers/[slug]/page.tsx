  ...
  return <>
    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        ...
        <SourceMetricScoreBadge score={supplier.score??0} label={hasScores?'Based on buyer evaluations':'Not yet rated'}/>
      </section>
